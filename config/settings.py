...
SECRET_KEY = 'django-insecure-wzsy6cqx96i)k!)4)2*jdlt&7t_*8=j#(dxmqg=i#_v=#e#hsb'
AUTH_USER_MODEL = "users.User"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['relfax.ca', 'www.relfax.ca','relfax.com', 'www.relfax.com','localhost']
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(days=30),      # Default: 5 minutes
